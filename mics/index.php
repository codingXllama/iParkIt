...
<head>
    ...
    <title>Home - iParkIt</title>
    <link rel="stylesheet" href="/assets/bootstrap/css/bootstrap.min.css?h=fa6b9afdb17a0869520a0875799c5fdf">
...
<body>
    ...
    <main class="page landing-page">
        <section class="clean-block clean-hero" style="background-image:url(&quot;/assets/img/bg2.jpg?h=0adc0de9a17a7caea6b8641f5d6ae02c&quot;);color:rgba(9, 162, 2533, 0.75);">
            <div class="text">
                <h2>Simple Parking For Everyone!</h2>
                <p>Find & Claim a Parking spot near you today!&nbsp;</p><button class="btn btn-outline-light btn-lg" type="button">Learn More</button>
            </div>
        </section>
